...
class JasperPHP
{
    ...
    public function execute($run_as_user = false)
    {
        ...
        if($return_var != 0)
            throw new \Exception("Your report has an error and couldn't be processed! Try to output the command using the function `output();` and run it manually in the console.".$this->the_command, 1);
