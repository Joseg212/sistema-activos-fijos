...
![Estructura del proyecto](assets/bin/portada1.png)
...
```bash
git clone https://github.com/jghernandez/sistema-activos-fijos.git
...
mysql -u usuario -p activos_fijos < database/scripts/tablas.sql
```
...
```env
DATABASE_URL="mysql://usuario:password@localhost:3306/activos_fijos"
APP_ENV=prod
